    ...
    tf_broadcaster(this)
{
    ...
    declare_parameter("detector.refine_edges", td->refine_edges, descr("snap to strong gradients"));
    ...
    declare_parameter<bool>("refine_pose", false, descr("increase the accuracy of the extracted pose"));
